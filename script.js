...
function TicTacToe(placeholder, grid_size, callback) {
    ...
    // Save player names
    this.players = {
        X: "Player 1", // Default name for Player X
        O: "Player 2"  // Default name for Player O
    };
...
TicTacToe.prototype.setPlayerNames = function(playerXName, playerOName) {
    this.players.X = playerXName || "Player 1";
    this.players.O = playerOName || "Player 2";
};

// ... (rest of your code)

// Use the setPlayerNames function to set player names
var playerXName = prompt("Enter name for Player X:") || "Player 1";
var playerOName = prompt("Enter name for Player O:") || "Player 2";

tictactoe.setPlayerNames(playerXName, playerOName);
